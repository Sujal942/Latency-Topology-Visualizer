    ...
    <div className="min-h-screen w-full bg-black font-body text-foreground antialiased">
      <main className="container mx-auto p-4 sm:p-6 lg:p-8">
        <Tabs
          ...
          className="w-full"
        >
          <TabsList className="grid w-full grid-cols-2 max-w-md mx-auto mb-6 bg-gray-800/80 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-2 gap-4 h-auto shadow-xl">
            <TabsTrigger
              value="market"
